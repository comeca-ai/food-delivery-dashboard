...
# =================================================
# PARTE 1: FUNÇÕES DO DEPLOY_DASHBOARDS_ONLINE.PY
# =================================================
...
# Função para configurar a pasta assets
def setup_assets_folder():
    try:
        ...
        # Ícone para a aplicação
        icon_content = """<svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="50" cy="50" r="50" fill="#EA1D2C"/>
        <path d="M30 35H70V65H30V35Z" fill="white"/>
        <path d="M35 40H65V45H35V40Z" fill="#EA1D2C"/>
        <path d="M35 50H65V55H35V50Z" fill="#EA1D2C"/>
        <path d="M35 60H65V65H35V60Z" fill="#EA1D2C"/>
        <path d="M75 40C75 37.2386 77.2386 35 80 35C82.7614 35 85 37.2386 85 40V60C85 62.7614 82.7614 65 80 65C77.2386 65 75 62.7614 75 60V40Z" fill="white"/>
        <path d="M15 40C15 37.2386 17.2386 35 20 35C22.7614 35 25 37.2386 25 40V60C25 62.7614 22.7614 65 20 65C17.2386 65 15 62.7614 15 60V40Z" fill="white"/>
        </svg>"""
        
        # Criar imagem PNG simulada
        with open(os.path.join("assets", "delivery-icon.png"), "w") as f:
    ...
    def update_commission_rates(id):
        ...
        return figmedia (max-width: 768px) {
            .timeline-content {
        ...
        print(f"Erro ao configurar pasta assets: {e}")
        return False
